...
CREATE OR REFRESH STREAMING TABLE dashboards.dbsql_warehouse_advisor.warehouse_query_history
--TBLPROPERTIES ('pipelines.channel' = 'PREVIEW')
...
CREATE OR REFRESH STREAMING TABLE dashboards.dbsql_warehouse_advisor.warehouse_usage
SCHEDULE CRON '0 0 * * * ? *' -- hourly
...
CREATE OR REFRESH STREAMING TABLE dashboards.dbsql_warehouse_advisor.warehouse_scaling_events
SCHEDULE CRON '0 0 * * * ? *' -- hourly
...
CREATE OR REFRESH STREAMING TABLE dashboards.dbsql_warehouse_advisor.warehouse_raw_events
SCHEDULE CRON '0 0 * * * ? *' -- hourly
